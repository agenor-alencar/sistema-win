...
CREATE TABLE motoristas (
    ...
    status_disponibilidade VARCHAR(20) DEFAULT 'DISPONIVEL' CHECK (status_disponibilidade IN ('DISPONIVEL', 'OCUPADO', 'OFFLINE')),
    data_cadastro TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE imagens_produto (
    ...
    tipo_arquivo VARCHAR(50) CHECK (tipo_arquivo IN ('imagem', 'video')) DEFAULT 'imagem',
